    ...
    try {
      ...
      if (response.ok) {
        ...
        if (typeof window.ym !== 'undefined') {
          // @ts-ignore
          window.ym(106024104, 'reachGoal', 'lead_form');
        }
      } else {
        alert('Ошибка отправки. Попробуйте по телефону.');
        setFormState('idle');
      }
    } catch (error) {
      console.error(error);
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start group">
                  ...
                  <div className="ml-6">
                    ...
                    <a href="tel:+79991234567" className="text-lg text-brand-900 font-medium hover:text-brand-red transition-colors" onClick={() => typeof window.ym !== 'undefined' && window.ym(106024104, 'reachGoal', 'click_phone')}>
                      +7 (999) 123-45-67
                    </a>
                ...
                <div className="flex items-start group">
                  ...
                  <div className="ml-6">
                    ...
                    <a href="mailto:info@sovetnik-expert.ru" className="text-lg text-brand-900 font-medium hover:text-brand-red transition-colors" onClick={() => typeof window.ym !== 'undefined' && window.ym(106024104, 'reachGoal', 'click_email')}>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-2 mb-8">
                    ...
                    <textarea
                      ...
                      className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:border-brand-red focus:bg-white transition-all text-brand-900 resize-none"
                    ></textarea>
                  </div>
