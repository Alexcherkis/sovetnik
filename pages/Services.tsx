               ...
               <div className="relative group overflow-hidden">
                 <div className="flex items-center overflow-x-auto no-scrollbar gap-2 pb-1 md:pb-0 -mx-4 px-4 md:mx-0 md:px-0">
                    <button 
                      ...
                      className={`flex items-center px-4 py-2 md:px-5 md:py-2.5 rounded-full border transition-all duration-200 whitespace-nowrap text-[12px] md:text-sm font-bold flex-shrink-0 ${
                        activeCategory === 'all' 
