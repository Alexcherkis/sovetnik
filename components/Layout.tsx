            ...
            <div className="flex items-center gap-2 md:gap-6 z-50">
              ...
              <div className={`hidden xl:flex flex-col items-end ${textClass}`}>
                <a
                  ...
                  onClick={() => typeof window.ym !== 'undefined' && window.ym(106024104, 'reachGoal', 'click_phone')}
                >
                  +7 (999) 123-45-67
                </a>
      ...
      >
        ...
        <div className="p-6 border-t border-gray-100 bg-white shrink-0 pb-10 safe-area-bottom shadow-[0_-4px_20px_rgba(0,0,0,0.03)] z-10">
          ...
          <div className="flex justify-between items-center px-2">
            <a href="tel:+79991234567" className="flex flex-col" onClick={() => typeof window.ym !== 'undefined' && window.ym(106024104, 'reachGoal', 'click_phone')}>
            ...
            <a href="tel:+79991234567" className="w-12 h-12 bg-brand-50 rounded-full flex items-center justify-center text-brand-red active:bg-brand-red active:text-white transition-colors" onClick={() => typeof window.ym !== 'undefined' && window.ym(106024104, 'reachGoal', 'click_phone')}>
              <Phone size={24} />
            </a>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 md:px-6">
          ...
          <FooterColumn title="Контакты">
            <ul className="space-y-4 text-[15px] text-slate-400 font-light">
              ...
              <li className="flex items-center group">
                ...
                <a href="tel:+79991234567" className="hover:text-white font-medium text-white transition-colors tracking-wide" onClick={() => typeof window.ym !== 'undefined' && window.ym(106024104, 'reachGoal', 'click_phone')}>+7 (999) 123-45-67</a>
              </li>
              <li className="flex items-center group">
                <Mail className="mr-3 text-brand-gold shrink-0" size={18} />
                <a href="mailto:info@sovetnik-expert.ru" className="hover:text-white transition-colors" onClick={() => typeof window.ym !== 'undefined' && window.ym(106024104, 'reachGoal', 'click_email')}>info@sovetnik-expert.ru</a>
              </li>
            </ul>
          </FooterColumn>
        </div>
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 gap-4 text-center md:text-left font-light tracking-wide">
          <div className="flex flex-col md:flex-row gap-4 items-center">
            <p className="opacity-80">© {currentYear} Экспертное бюро "Советникъ". Все права защищены.</p>
            <div className="hidden md:block w-px h-3 bg-white/10"></div>
            <a href="https://direct-sites.ru/" target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-100 hover:text-brand-gold transition-all duration-300 flex items-center gap-2 group">
              <span className="w-1.5 h-1.5 rounded-full bg-brand-gold/50 group-hover:bg-brand-gold transition-colors"></span>
              Разработка сайта — Direct Sites
            </a>
          </div>
